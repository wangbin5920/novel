...
public class Generator {
    ...
    private static final String BASE_PACKAGE = "com.wangbin.novel";
    ...
    private static final String DATABASE_PASSWORD = "Wb610904";


    public static void main(String[] args) {

        // 传入需要生成的表名，多个用英文逗号分隔，所有用 all 表示
        genCode("book_content");
